#!/bin/bash
# PORTMASTER: superrobotninjagirl.zip, Super Robot Ninja Girl.sh
...
GAMEDIR=/$directory/ports/superrobotninjagirl
...
$GPTOKEYB "gmloader" -c ./superrobotninjagirl.gptk &

$ESUDO chmod +x "$GAMEDIR/gmloader"

./gmloader superrobotninjagirl.apk
