#!/bin/bash
# PORTMASTER: pocketwondersport.zip, Pocket Wonder Sport.sh
...
GAMEDIR=/$directory/ports/pocketwondersport
...
$GPTOKEYB "gmloader" -c ./pocketwondersport.gptk &

$ESUDO chmod +x "$GAMEDIR/gmloader"

./gmloader pocketwondersport.apk
