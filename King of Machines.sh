#!/bin/bash
# PORTMASTER: kingofmachines.zip, King of Machines.sh
...
GAMEDIR=/$directory/ports/kingofmachines
...
$GPTOKEYB "gmloader" -c ./kingofmachines.gptk &

$ESUDO chmod +x "$GAMEDIR/gmloader"

./gmloader kingofmachines.apk
